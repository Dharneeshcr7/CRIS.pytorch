...
class RefSegDataset(Dataset):
    def __init__(self, img_dir, mask_dir,  mode, input_size,
                 word_length,sentence):
        super(RefSegDataset, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            word_vec = tokenize(self.sentence, self.word_length, True).squeeze(0)
            ...
            params = {
                ...
                'inverse': mat_inv,
                'ori_size': np.array(img_size),
                'sents': (self.sentence)*len(self.image_paths)
            }
            return img, params
